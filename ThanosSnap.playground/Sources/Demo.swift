...
public class MyViewController : UIViewController {
    ...
    func turnCellsToDust() {
        if let context = snapContext,
            context.index <  context.cells.count {
...
extension MyViewController: UITableViewDataSource  {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let imageName = result.imageName,
            let path = Bundle.main.path(forResource: imageName, ofType: "png", inDirectory: "Images"),
...
extension MyViewController: ThanosGauntletDelegate {
    public func ThanosGauntletDidSnapped() {
    ...
    public func ThanosGauntletDidReversed() {
        if let context = snapContext {
...
extension MyViewController: DustEffectViewDelegate {
    public func DustEffectDidCompleted() {
        turnCellsToDust()
    }
}
...
extension UIView {
    func renderToImage() -> UIImage? {
        ...
        let render = UIGraphicsImageRenderer(size: bounds.size, format: format)
