...
public protocol DustEffectViewDelegate: class {
    func DustEffectDidCompleted()
}

public class DustEffectView: UIView, CAAnimationDelegate {
    
    public weak var delegate: DustEffectViewDelegate?
    ...
    public var image: UIImage? {
        didSet {
            if let image = image {
                ...
                let path = Bundle.main.path(forResource: "thanos_dust_\(Int.random(in: 1...6))", ofType: "mp3", inDirectory: "Sounds")!
